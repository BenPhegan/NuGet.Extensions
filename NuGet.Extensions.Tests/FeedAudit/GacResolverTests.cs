...
namespace NuGet.Extensions.Tests.FeedAudit
{
    ...
    public class GacResolverTests
    {
        ...
        [TestCase("System.Xml, Version=4.0.0.0, Culture=neutral, PublicKeyToken=null, ProcessorArchitecture=MSIL", Result = true, Description = "Using full name", Ignored=true)]
